...
public class MainClient extends WindowAdapter implements ActionListener
{
	...
	private MainClient()
	{
		mainFrame= new JFrame("Steganograph "+ Steganograph.VERSION+ "  ");
		...
		gbc.gridx= 2;	gbc.gridy= 3;	gbl.setConstraints(lblPhone, gbc);
...
//		mainPanel.add(panelAbout);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(source== mnuExit)
		{
			...
			{
				JOptionPane.showMessageDialog(mainFrame, "Thanks for using this Steganograph.)", "From the Author", JOptionPane.INFORMATION_MESSAGE);
				System.exit(0);
			}
		}
	}
